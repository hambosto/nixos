  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      input = {
        ...
        touchpad = {
          natural_scroll = true;
          scroll_factor = 1.0; # Touchzpad scroll factor
        };
      };
      ...
      windowrule = [
        "float on, move ((monitor_w*0.695)) ((monitor_h*0.04)), pin on, match:title ^(Picture-in-Picture)$"
        "float on, size 700 600, center on, pin on, match:class (.*org.pulseaudio.pavucontrol.*)"
        "center on, size 800 600, float on, match:title ^(Open File)(.*)$"
        "center on, size 800 600, float on, match:title ^(Select a File)(.*)$"
        "center on, size 800 600, float on, match:title ^(Choose wallpaper)(.*)$"
        "center on, size 800 600, float on, match:title ^(Open Folder)(.*)$"
        "center on, size 800 600, float on, match:title ^(Save As)(.*)$"
        "center on, size 800 600, float on, match:title ^(File Upload)(.*)$"
        "center on, size 500 400, float on, match:title ^(.*Network Manager.*)$"
